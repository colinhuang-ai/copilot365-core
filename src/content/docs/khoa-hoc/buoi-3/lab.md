...
Nếu Copilot **không phân tích được** (nút mờ, báo lỗi), kiểm tra lại: (1) dữ liệu đã là **Table** (`Ctrl+T`)? (2) file đã ở **OneDrive/SharePoint**? (3) **AutoSave** đã bật? Xem lại [Unit 0 · Điều kiện tiên quyết](/khoa-hoc/buoi-3/ly-thuyet/0-dieu-kien/).
:::
...
👉 Tiếp theo: [✍️ Bài tập →](/khoa-hoc/buoi-3/bai-tap/)
